...
const configureSwagger = router => {
  const swaggerDocument = {
    openapi: "3.0.0",
    info: {
      title: "API do Desafio Users Hunter",
      version: "1.0.0",
      description: "API Node.js, consumindo a API Externa randomuser e um CRUD de usuários"
    },
    paths: {
      "/users": {
        post: {
      ...
      "/users/{id}": {
        ...
        put: {
          ...
          description: "Atualiza um usuário com base no ID fornecido e nos dados fornecidos",
          parameters: [{
            name: "id",
            in: "path",
